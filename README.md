...
👉 More PRs:  
https://github.com/search?q=is%3Apr+author%3APassion-Over-Pain&type=pullrequests
...
JavaScript + Electron, powered by a JSON-driven story system and a recursive event engine.  
Includes combat, progression, inventory, and file-based save/load.

Still evolving (v1.0.3) with early traction.
...
Deputy Chairperson — NMU Computer Society  
Hackathons with NTT Data, Telkom, Geekulcha (147 attendees hosted)  
Google-affiliated Cybersecurity Program  
IBMA Conference participation  
